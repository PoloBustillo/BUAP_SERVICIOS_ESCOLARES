...
public class Utils {
    ...
    static final String CREATE_ESTUDIANTE_FLOW_NAME = "Crear Estudiante";
    static final String CREATE_CURSO_FLOW_NAME = "Crear Curso";
    ...
    static final String LOOK_AND_FEEL = "Nimbus";
